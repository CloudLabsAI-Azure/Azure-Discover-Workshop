...
You have completed the Hands-on Lab, in this Hands-on Lab you explored on migrating the database, web app and SSIS packages to Azure with the help of ADF and DMS. You also have explored on multiple services offered for securing the Azure SQLMI Database.
